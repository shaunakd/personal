...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(EMPTY_TEXT_FILE_DIR, "", id=EMPTY_TEXT_FILE_DIR.name),
        pytest.param(NO_TEXT_FILE_DIR, None, id=NO_TEXT_FILE_DIR.name),
        pytest.param(
            TEXT_FILE_EXISTS_DIR,
