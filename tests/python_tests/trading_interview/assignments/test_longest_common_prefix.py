import pytest
from src.python_projects.trading_interview.assignments.longest_common_prefix import get_longest_common_prefix
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(["interspecies", "interstellar", "interstate"], "inters", id="common_prefix_inters"),
        ...
        pytest.param(["short", "shorter", "shortest"], "short", id="common_prefix_short"),
        pytest.param(["same", "same", "same"], "same", id="all_words_same"),
        pytest.param(["prefix", "prefixes", "prefixation"], "prefix", id="common_prefix_prefix"),
        pytest.param(["common", "commute", "communication"], "comm", id="common_prefix_comm"),
        ...
        pytest.param(["different", "words", "here"], "", id="no_common_prefix_different_words"),
